...
console.log("------------------------------------------------------------------------------------------------------------------------");
console.log("------------------------------------------------------------------------------------------------------------------------");
console.log("Buscamos el DNI: 32771501C, y añadimos al registro en que se encuentra, una nueva dirección, nuevo mail y nuevo teléfono");
console.log("------------------------------------------------------------------------------------------------------------------------");
console.log("------------------------------------------------------------------------------------------------------------------------");
// Añadir elemento al array
var dnib = "32771501C";
for (var i = 0; i < morePersons.length; i++) {
    if (morePersons[i].dni == dnib) {
        morePersons[i].addresses.push((address4));
        morePersons[i].emails.push((mail4));
        morePersons[i].phones.push((phone4));
        console.log(" ");
        console.log(" ");
        console.log("Se encuentra el DNI buscado en el índice ", i);
        console.log(" ");
        console.log(" ");
        console.log("Añadimos la nueva dirección, mail y teléfono al registro ", i);
        console.log(" ");
        console.log(" ");
        console.log("---------------------------------------------------");
        console.log("Este es el resultado, después de añadir los datos: ");
        console.log("---------------------------------------------------");
        console.log(" ");
        console.log(" ");
        //console.log(morePersons[i]);
        console.log(morePersons[0]);
        console.log(morePersons[1]);
        console.log(morePersons[2]);
    }
